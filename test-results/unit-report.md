...
**✅ PASSED** — 37/37 tests passed in 2.09s

_2026-05-16 01:53:02 UTC_
...
- ✅ should respond to GET request with health status _(25ms)_
...
- ✅ should handle initialize request _(20ms)_
- ✅ tools/list should return exactly 3 tools: list_skills, load_skill, read_skill_resource _(17ms)_
- ✅ list_skills should return JSON array with 10 skills, each with name + description _(17ms)_
- ✅ load_skill with valid name returns non-empty markdown body _(14ms)_
- ✅ load_skill with invalid name returns isError: true _(14ms)_
...
- ✅ read_skill_resource with invalid skill name returns isError: true _(14ms)_

### Adobe Developer Skills MCP Server › Error Handling

- ✅ should handle invalid JSON-RPC request _(2ms)_
- ✅ should handle unknown tool call _(14ms)_
