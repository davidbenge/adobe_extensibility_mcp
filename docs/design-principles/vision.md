...
- 10 skill domains served correctly
...
| `workfront-tasks-api` | Workfront Tasks (TASK) — CRUD, fields, bulk ops, queries |
| `workfront-issues-api` | Workfront Issues/Requests (OPTASK) — CRUD, assignments, status, queries |
| `workfront-forms-api` | Workfront Custom Forms — Category, Parameter, parameterValues (all object types) |
...
| `workfront-approvals-api` | Workfront Approvals — approval processes, decisions, routes |
