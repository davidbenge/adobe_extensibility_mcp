...
**Invoked by**: User
**Chains to**: Jira push (if configured), archive story artifacts
...
- Push story-plan to Jira via MCP (requires Jira MCP server configured; use Jira project and component from design-principles vision or architecture if defined; otherwise proceed as usual)
